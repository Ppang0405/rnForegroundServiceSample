...
import {Example, ForegroundServiceAvailablePackages, ForegroundServiceV2, NotifeeForegroundService, Startup, ForegroundService} from '@/screens';
	...
	return (
		<NavigationContainer theme={navigationTheme}>
			<Stack.Navigator key={variant} screenOptions={{ headerShown: false }}>
				...
				<Stack.Screen name={"ForegroundService"} component={ForegroundService} />
